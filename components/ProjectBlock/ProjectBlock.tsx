        ...
        <div className={styles.descriptionContainer}>
          ...
          <div className={styles.text}>
            ...
            <p>
              ...
              Machine Learning with Python, OOP with Java.
            </p>
            <p>
              Using those skills, I competed in multiple Hackathons and created fabulous
              applications.
            </p>
            <p>
            ...
            <p>
              In the future, I aspire to learn as much as possible and become a dependable Tech
              Lead.
            </p>
          </div>
